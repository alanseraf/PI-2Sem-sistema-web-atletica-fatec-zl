...
const mensagensDeErro = {
    ...
    confirmacao: {
        ...
        customError: 'As senhas digitadas são diferentes.'
    ...
    curso: {
        valueMissing: 'O campo curso não pode estar vazio.',
    },
    turma: {
        valueMissing: 'Digite aqui seu ano de ingresso e semestre. Ex: 2020 - 1º Semestre.',
    },
    telefone: {
...
const validadores = {
    ...
    confirmacao: input => validaSenha(input)
    /*
...
// ====================================================================================> validação de confirmacao senha

function validaSenha(input){
    
    const senha = document.querySelector('[data-tipo="senha"]').value
    console.log(senha);
    const confirmacaoSenha = input.value;
    let mensagem = "";
